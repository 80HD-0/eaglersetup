...
echo "                m  #                                                   #     "
echo "                 \"\"  "
echo "2025 Melanie Pacheco, 80hd_0                                     Version 1.0"
echo "############################################################################"
...
if [ -z "$understandme" ]; then
	...
	echo "REQUIRED:"
	echo "- at least java 8, anything later will probably still work."
	...
	echo "- a debian-based linux distro (it will probably run on other distros, but not guaranteed.)"
	echo "NEEDED FOR WSS:"
